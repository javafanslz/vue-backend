      ...
      <el-col :span="24">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item label="课程编号">
            <el-input v-model="formInline.user.name" placeholder="课程编号" style="width: 140px;"></el-input>
          </el-form-item>
          <el-form-item label="课程名称">
            <el-input v-model="formInline.user.name" placeholder="课程名称" style="width: 140px;"></el-input>
          </el-form-item>
